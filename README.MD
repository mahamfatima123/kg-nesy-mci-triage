...
This branch extends [`main`](../../tree/main) with an **independent external validation** of the triage ontology against a structured, third-party triage scenario dataset (the **syn_STARTS** benchmark) - separate from, and additional to, the multi-seed RL robustness experiment reported in the paper's main results (Table 3).
...
Of the 2,000 raw scenarios, **630 had all required fields mechanically derivable** under the locked conversion rule (the rest were excluded, not guessed). Across those 630 scoreable cases:

| Gold category | Agreement |
|---|---|
| Green (Minor) | 20/20 |
| Yellow (Delayed) | 498/498 |
| Red (Immediate) | 110/110 |
| Black (Expectant) | 2/2 |
| **Overall** | **630/630 (100.0%)** |
